...
output "handoff_values" {
  description = "Convenience bundle of values to share with AxelSpire after apply (deployment_role_arn, customer_kms_key_arn, state_bucket_name, state_lock_table_name, customer_id, region)."
  value = {
